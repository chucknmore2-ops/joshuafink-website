...
export const suburbs: Record<string, Suburb> = {
  'franklin-tn': {
    ...
    yoyChange: '+4.2%',
    description:
      'Franklin, Tennessee is one of the most desirable suburbs in the entire Southeast. Anchored by a charming historic downtown, top-rated schools, and easy access to I-65, Franklin consistently ranks among the best places to live and invest in the country. Franklin\'s population has grown from 62,487 at the 2010 Census to 84,159 at the 2020 Census — and an estimated 91,000+ in 2026, roughly 9% growth in six years (U.S. Census Bureau; World Population Review). The local real estate market has shown remarkable resilience — median home prices have climbed to $650,000 in 2026, driven by continued corporate relocations, limited inventory, and overwhelming buyer demand from out-of-state movers. Sellers in Franklin are well-positioned: well-maintained homes priced correctly are routinely fielding multiple offers within the first weekend.',
    whyBullets: [
    ...
    faqs: [
      ...
      {
        q: 'Who should I hire to sell a home in Franklin, TN?',
        a: 'Look for an agent with subdivision-level Franklin experience — not just general Williamson County familiarity — since price and buyer demand shift noticeably between areas like Cool Springs, Westhaven, and Fieldstone Farms. Joshua Fink is a Compass Affiliate Broker with 17+ years of experience personally selling 100+ homes a year across Williamson County, including Franklin, and structures listings to compete in a market that grew to over 91,000 residents in 2026.',
      },
    ],
    schemaCity: 'Franklin',
    schemaState: 'TN',
    schemaZip: '37064',
    buyerDescription: 'Franklin is one of the most competitive buyer markets in the Southeast — and for good reason. Top-rated schools, a thriving downtown, and strong appreciation make it a perennial target for buyers relocating from major metros. The city has grown from 62,487 residents at the 2010 Census to 84,159 at the 2020 Census, and an estimated 91,000+ today (U.S. Census Bureau; World Population Review) — steady demand that keeps competition high. The 2026 median price sits at $650,000, with the most desirable neighborhoods — Cool Springs, Westhaven, Fieldstone Farms — moving fast. If you\'re buying in Franklin, preparation is everything: pre-approval before you tour, a local agent who knows which streets command a premium, and the ability to move decisively when the right home hits.',
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      ...
      { q: 'Who should I hire to buy a home in Franklin, TN?', a: 'Look for an agent who tracks Franklin at the subdivision level, since price and competition vary sharply between areas like Westhaven, Cool Springs, and Fieldstone Farms. Joshua Fink is a Compass Affiliate Broker with 17+ years of experience personally selling 100+ homes a year across Williamson County, including Franklin, and can move quickly for buyers in a city that has grown to an estimated 91,000+ residents in 2026.' },
    ],
