...
export const suburbs: Record<string, Suburb> = {
  ...
  'nolensville-tn': {
    ...
    schemaState: 'TN',
    schemaZip: '37135',
    buyerDescription: 'Nolensville offers something increasingly rare in Middle Tennessee: small-town charm inside Williamson County. Founded in 1797 and still centered on a historic downtown of 1800s-era buildings, the town has grown from 13,829 residents at the 2020 Census to an estimated 16,200+ in 2026 (U.S. Census Bureau) without losing that character. With a median price around $935,000, it sits between Franklin and Brentwood in price. Buyers are drawn to the established neighborhoods, top-tier schools, charming downtown, and the tight-knit community feel that larger suburbs can\'t replicate. Homes average 57 days on market here, but the most desirable listings move faster — so buyers need to be pre-approved and decisive.',
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Nolensville, TN in 2026?', a: 'The median home price in Nolensville is approximately $935,000, with price per square foot around $314. Larger homes in premium subdivisions regularly exceed $1M.' },
