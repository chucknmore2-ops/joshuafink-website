...
export const suburbs: Record<string, Suburb> = {
  ...
  'murfreesboro-tn': {
    ...
    faqs: [
      ...
      { q: 'Is Murfreesboro still growing?', a: 'Significantly. Murfreesboro grew from 153,801 residents at the 2020 Census to an estimated 175,000+ in 2026 — nearly 14% growth, ranking it the 16th fastest-growing city in the U.S. among cities over 100,000 people (U.S. Census Bureau; SmartAsset analysis). New employers, the MTSU effect, and proximity to Nashville continue to drive demand. Population growth translates directly to housing demand — a favorable tailwind for sellers.' },
    ...
    buyerFaqs: [
      ...
      { q: 'Is Murfreesboro a good investment?', a: 'One of the best in Middle Tennessee. Population grew nearly 14% since the 2020 Census (153,801 to an estimated 175,000+ in 2026, per the U.S. Census Bureau), and that growth plus MTSU rental demand, healthcare employment, and an affordable entry point make it a compelling buy-and-hold market. Appreciation has run nearly 5% year-over-year.' },
    ],
