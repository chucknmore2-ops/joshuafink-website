...
export const suburbs: Record<string, Suburb> = {
  'franklin-tn': {
    ...
    faqs: [
      {
        ...
        a: 'The median home price in Franklin is currently around $870,000, with price per square foot running approximately $337. However, your home\'s actual value depends on specific neighborhood, condition, updates, lot size, and school assignment. Joshua will pull the most recent sold comps within a half-mile of your address for a precise, defensible number.',
      },
      {
        q: 'How long does it take to sell a home in Franklin?',
        a: 'Well-priced homes in Franklin are averaging about 47 days on market in 2026. Homes in top school zones and updated interiors often sell in a weekend. The key is professional photography, accurate pricing, and launching on a Thursday to capture weekend traffic.',
      },
      {
    ...
    schemaState: 'TN',
    schemaZip: '37064',
    buyerDescription: 'Franklin is one of the most competitive buyer markets in the Southeast — and for good reason. Top-rated schools, a thriving downtown, and strong appreciation make it a perennial target for buyers relocating from major metros. The 2026 median price sits at approximately $870,000, with the most desirable neighborhoods — Cool Springs, Westhaven, Fieldstone Farms — moving fast. If you\'re buying in Franklin, preparation is everything: pre-approval before you tour, a local agent who knows which streets command a premium, and the ability to move decisively when the right home hits. School assignment still drives daily life and resale, so confirm the Williamson County zone for the exact address before you write — Cool Springs generally sits in the Centennial High corridor, while Westhaven and Fieldstone Farms pull different feeders. The lifestyle tradeoff is just as real: Cool Springs is the mixed residential, office, and retail corridor (condos, townhomes, and single-family near I-65 and the Galleria), Westhaven is the walkable master-planned community with a town center, and Fieldstone Farms is the established HOA subdivision with larger lots and mature trees. Offer prep is the same across all three: current pre-approval, a clear ceiling, and an agent who can price the specific street — not only the citywide median — before you tour.',
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Franklin, TN in 2026?', a: 'The median home price in Franklin is approximately $870,000. Entry-level homes in outer neighborhoods start around $450K; luxury properties in Westhaven or Governors Club run $1M+. The sweet spot for most buyers is $550K–$800K.' },
  ...
  'brentwood-tn': {
    ...
    whyBullets: [
      ...
      'Negotiation at a high-dollar level: At $1.4M+, each point of negotiation represents $14,000+ to your bottom line. Joshua\'s track record of 97%+ list-to-sale ratios means you\'re not leaving money on the table.',
    ],
    faqs: [
      {
        q: 'What is my Brentwood, TN home worth in 2026?',
        a: 'The median sale price in Brentwood has reached approximately $1.4 million in 2026, with price per square foot near $381. Luxury homes in established neighborhoods like Governors Club, Otter Creek, or Annandale may command a premium. Joshua conducts a thorough comparative market analysis using recent closed sales within your specific subdivision — not just city-wide averages.',
      },
      {
        q: 'How competitive is the Brentwood real estate market?',
        a: 'Brentwood remains a seller\'s market in 2026. Inventory is limited relative to buyer demand, and well-presented homes priced correctly are averaging about 61 days on market. Move-in ready homes with updated kitchens and primary suites are generating the most activity.',
      },
      {
      ...
      },
      {
        ...
        a: 'At Brentwood\'s price point, professional staging or at minimum a pre-listing consultation is highly recommended. Joshua partners with local staging professionals and can coordinate at a preferred rate. Staged homes in this price range consistently sell faster and at higher prices than vacant or unstaged alternatives.',
      },
    ],
    schemaCity: 'Brentwood',
    schemaState: 'TN',
    schemaZip: '37027',
    buyerDescription: 'Brentwood sets the standard for luxury suburban living in Middle Tennessee. With a median price near $1.4 million, it attracts executives, physicians, and families who want exceptional schools, large lots, and a safe, established community. Inventory here is always limited — serious buyers need a pre-approval in hand and an agent with relationships. Homes in Governors Club, Otter Creek, and Annandale rarely last more than a few weeks. If Brentwood is your target, working with a local expert who can surface off-market opportunities is the edge that makes the difference.',
    buyerWhyBullets: [
      'Luxury market expertise: Joshua understands the nuances of Brentwood\'s premium subdivisions — HOA rules, lot premiums, and which streets hold value best. You\'re not just buying a home, you\'re making a $1.4M+ investment decision.',
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Brentwood, TN in 2026?', a: 'The median home price in Brentwood is approximately $1.4 million. Entry-level homes in Brentwood start around $650K; luxury estates in Governors Club or custom builds run $2M+.' },
  ...
  'spring-hill-tn': {
    ...
    medianPrice: '$532,348',
    medianPriceNum: 532348,
    avgDaysOnMarket: 62,
    pricePerSqft: 235,
    yoyChange: '+2.4%',
    description:
      'Spring Hill is one of the fastest-growing cities in Tennessee — and that growth is showing up in real estate values. The city grew from 50,005 residents at the 2020 Census to an estimated 55,765 by 2024 (U.S. Census Bureau) — about 11.5% growth in just four years. Straddling the Williamson/Maury County line, Spring Hill offers new construction communities, highly rated Williamson County schools, and a more attainable entry point than Franklin or Brentwood without sacrificing convenience. The 2026 median home price is approximately $532,000, up about 2.4% year-over-year. Buyers love Spring Hill\'s mix of newer neighborhoods, growing retail and dining scene, and quick access to I-65. If you own here, you own in a market that continues to attract first-time buyers and move-up purchasers in equal measure — making your exit strategy strong.',
    whyBullets: [
      'Growth-backed demand: Spring Hill grew about 11.5% from the 2020 Census to 2024 (50,005 to an estimated 55,765, U.S. Census Bureau) — among the fastest rates in Tennessee. Joshua has navigated dozens of transactions across the newest subdivisions — from Autumn Ridge to Bridgemore Village — with intimate knowledge of which communities command the strongest resale premiums.',
    ...
    faqs: [
      {
        ...
        a: 'Spring Hill\'s median home price is approximately $532,000 in 2026, with price per square foot around $235. Homes in Williamson County school zones often carry a noticeable premium over those zoned to Maury County. Joshua will pinpoint exactly where your home sits and price accordingly.',
      },
      {
      ...
      },
      {
        ...
        a: 'Spring Hill still leans seller-favorable, though inventory has increased slightly with new construction deliveries. Well-priced, well-presented resale homes are averaging 62 days on market. Homes priced at or below the median are seeing the strongest activity and most competitive offer situations.',
      },
      {
      ...
      {
        q: 'Is Spring Hill still growing?',
        a: 'Yes, rapidly. Spring Hill grew from 50,005 residents at the 2020 Census to an estimated 55,765 by 2024 (U.S. Census Bureau) — about 11.5% growth in just four years, among the fastest rates in Tennessee. That sustained population growth is a direct tailwind for home demand and a reason sellers here continue to see strong buyer competition.',
      },
    ],
    schemaCity: 'Spring Hill',
    schemaState: 'TN',
    schemaZip: '37174',
    buyerDescription: 'Spring Hill is the smart buyer\'s play in 2026 — Williamson County schools, new construction communities, and a price point that still makes sense. The city has grown about 11.5% since the 2020 Census (50,005 to an estimated 55,765 by 2024, U.S. Census Bureau), one of the fastest rates in Tennessee. With a median around $532,000, it\'s the most accessible entry point into Williamson County. Buyers love the new neighborhoods, growing restaurant and retail scene, and the I-65 corridor that puts you in downtown Nashville in under 30 minutes. Competition is real here — Spring Hill attracts first-time buyers, move-up families, and out-of-state relocators in equal measure.',
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Spring Hill, TN in 2026?', a: 'The median home price in Spring Hill is approximately $532,000. Entry-level new construction starts around $380K; larger homes with premium lots run $550K–$650K.' },
      ...
      { q: 'Is Spring Hill a good investment?', a: 'Spring Hill has seen strong appreciation in recent years and continues to attract new employers and residents. It remains one of the best value-to-appreciation opportunities in Middle Tennessee.' },
      { q: 'How fast is Spring Hill growing?', a: 'Very fast — the city grew from 50,005 residents at the 2020 Census to an estimated 55,765 by 2024 (U.S. Census Bureau), about 11.5% in four years, among the fastest rates in Tennessee. That growth is a strong signal for long-term buyer demand.' },
    ],
  ...
  'nolensville-tn': {
    ...
    faqs: [
      {
        ...
        a: 'The median sale price in Nolensville is approximately $935,000 in 2026, with price per square foot near $314. Homes in newer subdivisions with premium lots, 4+ bedrooms, and community pools are consistently selling above median. Joshua will run comps specific to your street and subdivision for an accurate valuation.',
      },
      {
        q: 'How quickly are homes selling in Nolensville right now?',
        a: 'Homes in Nolensville are averaging 57 days on market in 2026. Correctly priced, well-presented homes in desirable subdivisions are still seeing multiple offers.',
      },
      {
    ...
    schemaState: 'TN',
    schemaZip: '37135',
    buyerDescription: 'Nolensville offers something increasingly rare in Middle Tennessee: small-town charm inside Williamson County. Founded in 1797 and still centered on a historic downtown of 1800s-era buildings, the town has grown from 13,829 residents at the 2020 Census to an estimated 16,200+ in 2026 (U.S. Census Bureau) without losing that character. With a median price around $935,000, it sits between Franklin and Brentwood in price. Buyers are drawn to Williamson County Schools, a walkable historic core, and subdivisions that do not all live the same way. Bent Creek is the large established family community — mature trees, multiple pools, 2000s–early-2010s stock. Scales Farmstead is the newer Clovercroft Road brick neighborhood with a clubhouse-and-pool HOA and typical Jordan Elementary / Sunset Middle / Nolensville High assignments. Benington is custom half-acre homes off Sunset Road (often a Sunset Elementary / Sunset Middle walk), and it shares its pool and clubhouse with neighboring Winterset Woods — know that before you tour. Burberry Glen is another current-vintage family option if you want newer floor plans without Benington custom pricing. School assignment still drives daily life and resale, so confirm the Williamson County zone for the exact address before you write. Homes average 57 days on market citywide, but the most desirable listings move faster — so buyers need to be pre-approved and decisive. Joshua prices the specific street and subdivision, not only the citywide median.',
    buyerWhyBullets: [
      'Hyperlocal subdivision knowledge: Nolensville is not one product. Bent Creek (established, mature trees), Scales Farmstead (newer Clovercroft brick + amenity HOA), and Benington (custom half-acre on Sunset, amenities shared with Winterset Woods) price and feel differently. Joshua matches the street to your budget, school walk, and lot-size priority.',
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Nolensville, TN in 2026?', a: 'The median home price in Nolensville is approximately $935,000, with price per square foot around $314. That is a citywide figure — not a subdivision median. Larger custom homes in Benington and premium Scales Farmstead lots regularly exceed $1M; Bent Creek and Burberry Glen often enter below that. Joshua prices the specific street against recent closed comps.' },
      { q: 'How competitive is the Nolensville housing market?', a: 'Very competitive for the most desirable homes, which still often receive multiple offers even with the market averaging 57 days. Having your financing ready and a decisive mindset is critical. Joshua will help you build offers that win without overpaying.' },
      { q: 'What are the best neighborhoods in Nolensville for families?', a: 'Bent Creek and Scales Farmstead are the usual family starts — amenities plus Williamson County Schools (Scales commonly Jordan Elementary / Sunset Middle / Nolensville High). Benington is the custom half-acre ask near the Sunset campus, at a higher typical entry. Burberry Glen is another newer family subdivision if current-vintage floor plans matter more than lot size. Joshua will match budget, school walk, and HOA style — not a single “best” label.' },
      ...
      { q: 'Who should I hire to buy a home in Nolensville, TN?', a: 'Look for an agent with hyperlocal Nolensville subdivision knowledge — not just general Williamson County experience — since price and character shift noticeably between Bent Creek, Scales Farmstead, Benington, and the historic downtown core. Joshua Fink is a Compass Affiliate Broker with 17+ years of experience personally selling 100+ homes a year across Williamson County, including Nolensville, and can move quickly when the right listing hits the market.' },
    ],
  ...
  'thompsons-station-tn': {
    ...
    county: 'Williamson County',
    medianPrice: '$842,068',
    medianPriceNum: 842068,
    avgDaysOnMarket: 64,
    pricePerSqft: 303,
    yoyChange: '+0.6%',
    description:
      "Thompson's Station is one of Middle Tennessee's best-kept secrets — and that's starting to change. Located just south of Spring Hill along the I-65 corridor in Williamson County, Thompson's Station offers the county's prized school district, acreage lots not found elsewhere at this price point, and a rural character that's increasingly rare as the region grows. The town's population has grown from 2,194 at the 2010 Census to 7,485 in the 2020 Census — and an estimated 9,800+ today, a roughly 30% increase in just five years — making it the fastest-growing city in Tennessee for 2026 (U.S. Census Bureau; HomeSnacks). The 2026 median home price is approximately $842,000 — still below neighboring Franklin, Nolensville, and Brentwood. Prices are up about 0.6% year-over-year. Buyers are actively seeking Thompson's Station for its space, its schools, and its value relative to neighboring Franklin and Nolensville. If you own here, you own something buyers are genuinely competing for.",
    whyBullets: [
    ...
    schemaState: 'TN',
    schemaZip: '37179',
    buyerDescription: "Thompson's Station is Williamson County's best-kept secret for buyers who want space and schools without the Franklin price tag. At a median of $842,000, it still comes in below Franklin, Nolensville, and Brentwood, with prices up about 0.6% year-over-year. Many homes sit on half-acre to multi-acre lots, offering privacy that's impossible to find in denser suburbs. If you're a buyer who wants land, quality schools, and long-term upside, this is the market to be in.",
    buyerWhyBullets: [
      "Value play with upside: Thompson's Station offers a lower price-per-square-foot than Franklin, Nolensville, or Brentwood while delivering the same school district. Joshua helps buyers understand exactly what they're getting and why the appreciation trajectory is compelling.",
    ...
    buyerFaqs: [
      { q: "What is the average home price in Thompson's Station, TN in 2026?", a: "The median home price is approximately $842,000 — still below Franklin, Nolensville, and Brentwood. Larger properties on acreage can run well above $1M" },
      { q: "Is Thompson's Station a good place to buy?", a: "For buyers seeking space, schools, and value, it's one of the best opportunities in Middle Tennessee right now. Williamson County schools, larger lots, and a rural character that's increasingly scarce." },
  ...
  'nashville-tn': {
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Nashville, TN in 2026?', a: 'The median is approximately $480,000, but it varies dramatically by neighborhood. East Nashville and 12 South run $450K–$700K+. Emerging areas like Bordeaux or parts of Madison offer entry points under $350K.' },
  ...
  'murfreesboro-tn': {
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Murfreesboro, TN in 2026?', a: 'The median is approximately $429,000. Entry-level homes start around $280K; newer construction in the northeast corridor runs $450K–$550K.' },
  ...
  'gallatin-tn': {
    ...
    medianPrice: '$439,780',
    medianPriceNum: 439780,
    avgDaysOnMarket: 76,
    pricePerSqft: 217,
    yoyChange: '+4.5%',
    description: 'Gallatin is having a moment. A more affordable entry point into Sumner County than neighboring Hendersonville, Gallatin has seen steady appreciation — about 4.5% year-over-year — as buyers priced out of Williamson County and Davidson County increasingly look north to Sumner County. The city\'s population has grown from about 44,400 at the 2020 Census to an estimated 53,000+ in 2026 — roughly 19% growth in five years (U.S. Census Bureau). The 2026 median home price is approximately $440,000, making it a value choice for families and first-time buyers who want space and community without the premium prices of Franklin or Brentwood. Gallatin offers a genuine small-town feel with a growing downtown, lakefront access to Old Hickory Lake, the main campus of Volunteer State Community College, and easy access to Hendersonville and the Gallatin Pike corridor to Nashville.',
    whyBullets: [
    ...
    faqs: [
      { q: 'What is my Gallatin, TN home worth in 2026?', a: 'The median home price in Gallatin is approximately $440,000. Waterfront or lake-access properties on Old Hickory Lake can command significant premiums above median. Joshua will pull recent sold comps specific to your neighborhood and property type.' },
      { q: 'Is Gallatin growing?', a: 'Yes — rapidly. Gallatin\'s population grew from about 44,400 at the 2020 Census to an estimated 53,000+ in 2026, roughly 19% in five years (U.S. Census Bureau), driven by affordability relative to the Nashville core. The city completed a $31 million connector road from SR-109 to Dobbins Pike in 2022, built to divert downtown Gallatin traffic and support that growth.' },
    ...
    schemaState: 'TN',
    schemaZip: '37066',
    buyerDescription: 'Gallatin is where smart buyers are going in 2026. At a median of $440,000 — the lowest entry point in the Nashville metro with access to Old Hickory Lake — it offers space, community, and one of the stronger appreciation rates in Middle Tennessee at 4.5% year-over-year. Buyers who moved here 3-5 years ago are sitting on significant equity. Those buying now are positioned for the next wave of growth: the city\'s population is up roughly 19% since the 2020 Census (U.S. Census Bureau), and Gallatin is already home to the main campus of Volunteer State Community College.',
    buyerWhyBullets: [
      'Strong value in the metro: Gallatin offers one of the lowest price-per-square-foot figures of any Nashville suburb while delivering the lifestyle and community buyers want. Joshua helps you find the right property in the right pocket to maximize your upside.',
      ...
      'Growth timing: Gallatin\'s population is up roughly 19% since the 2020 Census (U.S. Census Bureau). Buyers who get in now are buying ahead of a fast-growing city rather than chasing an already-priced-in market.',
    ],
    buyerFaqs: [
      { q: 'What is the average home price in Gallatin, TN in 2026?', a: 'The median is approximately $440,000 — still below the metro\'s Williamson County suburbs. Waterfront properties on Old Hickory Lake run $500K–$1M+.' },
      ...
      { q: 'Is Gallatin a good long-term investment?', a: 'Strong case for it. Affordability relative to the metro, consistent 5%+ appreciation, lakefront lifestyle appeal, and population growth of roughly 19% since the 2020 Census (U.S. Census Bureau) all support a positive outlook. One of the best value propositions in Middle Tennessee.' },
    ],
  ...
  'hendersonville-tn': {
    ...
    faqs: [
      { q: 'What is my Hendersonville, TN home worth in 2026?', a: 'The median home price in Hendersonville is approximately $533,000. Lake-access and waterfront properties command a significant premium. Joshua will pull neighborhood-specific comps and factor in any lake access or views for an accurate valuation.' },
      ...
      { q: 'Is Hendersonville a seller\'s market?', a: 'Yes. With 64 average days on market and consistent appreciation, Hendersonville leans seller-favorable. Well-priced, well-presented homes — especially with lake access — are seeing competitive offers.' },
    ...
    schemaState: 'TN',
    schemaZip: '37075',
    buyerDescription: 'Hendersonville gives buyers the best of both worlds: the community feel and lake lifestyle of a small city, with the amenities and access of a Nashville suburb. At a median of $533,000, it\'s more accessible than Williamson County while offering comparable quality of life. Its population has grown roughly 5% since the 2020 Census (61,753 to an estimated 64,800+ in 2026, per the U.S. Census Bureau) — steady, sustainable growth rather than a boom. Old Hickory Lake waterfront properties, strong schools, and established neighborhoods make it a perennial favorite for families relocating from out of state and Nashville buyers ready to slow down without leaving the metro.',
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Hendersonville, TN in 2026?', a: 'The median is approximately $533,000. Entry-level homes start around $320K; lakefront properties on Old Hickory run $600K–$1.5M+.' },
  ...
  'columbia-tn': {
    ...
    faqs: [
      { q: 'What is my Columbia, TN home worth in 2026?', a: 'The median price is approximately $385,000 with price per square foot near $210. Final value depends on neighborhood, updates, lot size, and proximity to downtown Columbia or key corridors. Joshua will provide a precise CMA based on nearby sold comps.' },
      { q: 'How fast are homes selling in Columbia?', a: 'Well-priced homes are averaging about 77 days on market. Updated properties and homes in desirable school zones can move faster, especially in the spring and summer selling seasons.' },
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Columbia, TN in 2026?', a: 'The median home price is around $385,000, with entry-level options below that and larger updated homes generally ranging higher.' },
  ...
  'mount-juliet-tn': {
    ...
    faqs: [
      { q: 'What is my Mount Juliet home worth in 2026?', a: 'The local median is about $563,000 with average pricing near $238 per square foot. Final value depends on subdivision, lot quality, updates, and school zone. Joshua provides a comp-backed valuation before listing.' },
      { q: 'How quickly do homes sell in Mount Juliet?', a: 'Average market time is approximately 70 days. Well-presented homes in desirable neighborhoods often move faster and may receive multiple offers.' },
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Mount Juliet, TN in 2026?', a: 'The median is approximately $563,000, with varied options from townhomes to larger single-family homes in master-planned communities.' },
  ...
  'lebanon-tn': {
    ...
    faqs: [
      { q: 'What is my Lebanon, TN home worth in 2026?', a: 'The median is roughly $426,000 with pricing around $206 per square foot. Your specific value depends on condition, location, and lot features. Joshua provides a tailored valuation using recent neighborhood comps.' },
      { q: 'How long do homes stay on market in Lebanon?', a: 'Average days on market are around 71 days. Properly priced homes in move-in-ready condition often move faster.' },
    ...
    schemaZip: '37087',
    dataUpdatedAt: '2026-08-20',
    buyerDescription: "Lebanon is a strong option for buyers who want value and space with reliable access to Nashville and surrounding job centers. It's also a market with a genuine employment anchor: Cracker Barrel's corporate headquarters and a large Under Armour distribution center have helped drive Lebanon's population up more than 44% since the 2020 Census. At a $426,000 median, it remains more attainable than many inner-ring suburbs while still offering stable appreciation. Joshua and Compass help buyers target neighborhoods with the best blend of price, lifestyle, and long-term resale value.",
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Lebanon, TN in 2026?', a: 'The median home price is approximately $426,000, with options across entry-level, new construction, and larger move-up inventory.' },
  ...
  'smyrna-tn': {
    ...
    county: 'Rutherford County',
    medianPrice: '$419,790',
    medianPriceNum: 419790,
    avgDaysOnMarket: 55,
    pricePerSqft: 216,
    yoyChange: '-2.2%',
    description: 'Smyrna is anchored by the Nissan Smyrna Vehicle Assembly Plant, the largest single-site auto plant in North America — producing roughly 640,000 vehicles a year and employing about 8,000 workers as the town\'s largest employer. That manufacturing base has driven real growth: Smyrna has climbed from 53,070 residents at the 2020 Census to an estimated 57,000+ in 2026, making it the largest town in Tennessee. With a 2026 median home price near $420,000 and homes averaging 55 days on market, Smyrna offers buyers and sellers a market backed by durable employment rather than pure Nashville-commuter speculation. Joshua Fink and Compass combine that local insight with modern marketing to position Smyrna properties for maximum visibility and return.',
    whyBullets: [
      'Employment-anchored demand: Nissan\'s Smyrna plant alone employs roughly 8,000 workers, giving the local market steady buyer demand that doesn\'t rise and fall with Nashville commuter cycles.',
    ...
    faqs: [
      { q: 'What is my Smyrna, TN home worth in 2026?', a: 'The median home price is approximately $420,000 with average pricing around $216 per square foot. Joshua will evaluate your exact location and upgrades for a precise valuation.' },
      { q: 'How quickly are homes selling in Smyrna?', a: 'Homes are averaging around 55 days on market. Updated homes in desirable pockets can move even faster.' },
      ...
      { q: 'What is driving Smyrna\'s growth?', a: 'The Nissan Smyrna Vehicle Assembly Plant — the largest single-site auto plant in North America, with roughly 8,000 employees — is the town\'s largest employer. That manufacturing base has helped Smyrna grow from 53,070 residents at the 2020 Census to an estimated 57,000+ today, making it the largest town in Tennessee and supporting steady, employment-driven home demand.' },
    ...
    schemaState: 'TN',
    schemaZip: '37167',
    buyerDescription: 'Smyrna gives buyers strong value, practical commute options, and stable market fundamentals backed by one of the region\'s largest employers. The Nissan Smyrna plant employs about 8,000 workers and has helped the town grow to an estimated 57,000+ residents in 2026 — the largest town in Tennessee. The $420,000 median makes it accessible for a wide range of budgets, while that employment base continues to support demand. Joshua and Compass help buyers identify the best-fit neighborhoods and negotiate confidently in a market where good homes move quickly.',
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      { q: 'What is the average home price in Smyrna, TN in 2026?', a: 'The median is around $420,000, with a broad mix of starter homes, newer builds, and move-up properties.' },
      { q: 'Is Smyrna good for commuters?', a: 'Yes. Smyrna provides convenient access to Nashville and surrounding employment hubs, making it popular with commuters — and it also has its own major employer on-site: the Nissan Smyrna plant, with about 8,000 jobs.' },
      ...
      { q: 'Is Smyrna a good long-term buy?', a: 'Smyrna has shown steady appreciation and consistent demand, and its population has grown from 53,070 (2020 Census) to an estimated 57,000+ today, making it a strong long-term option for many buyers.' },
    ],
  ...
  'la-vergne-tn': {
    ...
    county: 'Rutherford County',
    medianPrice: '$372,813',
    medianPriceNum: 372813,
    avgDaysOnMarket: 60,
    pricePerSqft: 217,
    yoyChange: '-0.6%',
    description: 'La Vergne sits at the crossroads of I-24, I-40, and I-65 in Rutherford County, and that logistics position is reshaping the market. The city has grown roughly 11% since the 2020 Census to an estimated 42,900+ residents in 2026 (U.S. Census Bureau), fueled by an expanding industrial and distribution base — including Amazon\'s local sortation and fulfillment operations and a new 1-million-square-foot warehouse under construction along I-24. With a 2026 median home price around $373,000, demand remains healthy among first-time buyers, workers relocating for that job growth, and budget-conscious commuters. Sellers in La Vergne benefit from this affordability-driven buyer pool and steady appreciation. Joshua Fink and Compass provide the local strategy needed to price accurately, market effectively, and move quickly in this active segment.',
    whyBullets: [
      'Affordability-driven demand: La Vergne consistently attracts qualified buyers priced out of Smyrna, Murfreesboro, and Nashville proper, drawn by the sub-$400K entry point and direct I-24/I-40/I-65 access.',
      ...
      'Industrial and logistics growth: a new 1-million-sq-ft warehouse under construction along I-24, plus Amazon\'s existing sortation and fulfillment presence, are adding jobs and rental demand that support home values in this price band.',
    ],
    faqs: [
      { q: 'What is my La Vergne, TN home worth in 2026?', a: 'Median pricing is around $373,000 with approximately $217 per square foot. Your home\'s value depends on condition, neighborhood, and upgrades. Joshua can provide a street-level valuation using recent sales.' },
      { q: 'How long does it take to sell in La Vergne?', a: 'Average days on market are roughly 60 days, with well-prepared homes often selling faster.' },
      { q: 'Is La Vergne still growing?', a: 'Yes — La Vergne\'s population has grown roughly 11% since the 2020 Census to an estimated 42,900+ residents in 2026, per U.S. Census Bureau data, driven in part by industrial and logistics expansion along the I-24 corridor, including Amazon\'s local distribution operations and a new 1-million-sq-ft warehouse under construction. That job growth is a direct tailwind for home demand.' },
    ...
    schemaState: 'TN',
    schemaZip: '37086',
    buyerDescription: 'La Vergne is a practical choice for buyers who want affordability, accessibility, and long-term ownership potential. The city has grown roughly 11% since the 2020 Census to an estimated 42,900+ residents, with a logistics-driven job base (Amazon, and a new 1-million-sq-ft warehouse under construction along I-24) adding steady demand. At a $373,000 median, it remains one of the better value opportunities in Rutherford County. Joshua and Compass help buyers evaluate neighborhoods, commute tradeoffs, and property condition so they can buy confidently and avoid costly surprises.',
    buyerWhyBullets: [
      ...
      'Commuter-aware neighborhood selection: Joshua pinpoints locations that balance budget with convenient access to Nashville and local employers via I-24, I-40, and I-65.',
    ],
    buyerFaqs: [
      { q: 'What is the average home price in La Vergne, TN in 2026?', a: 'The median is approximately $373,000, with options across entry-level single-family homes and newer subdivisions.' },
      { q: 'Is La Vergne good for first-time buyers?', a: 'Yes. It is one of the more attainable markets in the metro and often a strong starting point for first-time homeowners, with a population that has grown roughly 11% since the 2020 Census as the local job base expands.' },
...
export const marketStatsLastUpdated = '2026-08-20'
...
// 2026-08-20: figures above are Redfin Data Center city medians (median sale
// price, median days on market, sale-price YoY, median $/sqft), rolling 3
// months ending 2026-07-31.
export const marketStatsSource = 'Redfin'
