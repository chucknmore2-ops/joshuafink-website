...
export const suburbs: Record<string, Suburb> = {
  ...
  'brentwood-tn': {
    ...
    yoyChange: '+3.8%',
    description:
      'Brentwood, Tennessee carries a reputation as one of the wealthiest ZIP codes in the South — and the data backs it up. With a 2026 median home price approaching $900,000 and some of the highest-performing schools in the state, Brentwood attracts executives, professionals, and families who want space, safety, and community. The market here rewards sellers who present correctly: buyers at this price point have high expectations for condition, finishes, and marketing. Working with the right agent isn\'t just helpful in Brentwood — it directly impacts your final number. Inventory remains tight relative to demand, keeping the market squarely in seller-favoring territory. That tightness isn\'t a temporary blip: Brentwood\'s population has held essentially flat since 2020 — 45,373 residents at the 2020 Census versus an estimated 45,556 today, under 1% growth, per the U.S. Census Bureau — because the city is almost entirely built out with little land left for new subdivisions. Unlike fast-growing neighbors such as Spring Hill or Thompson\'s Station, Brentwood adds almost no new-construction supply, so existing homes rarely turn over — and when they do, competition is intense.',
    whyBullets: [
    ...
    faqs: [
      ...
      {
        q: 'Is Brentwood, TN still growing, or is inventory just tight?',
        a: "Brentwood's population has barely changed since 2020 — about 45,373 residents at the 2020 Census versus an estimated 45,556 today, per the U.S. Census Bureau. Unlike fast-growing Middle Tennessee suburbs, Brentwood is largely built out, so tight inventory isn't cyclical, it's structural: there's very little vacant land left for new subdivisions. That scarcity is exactly why well-presented listings attract strong competition and why accurate, market-savvy pricing from day one matters so much here.",
      },
    ],
    schemaCity: 'Brentwood',
    schemaState: 'TN',
    schemaZip: '37027',
    buyerDescription: 'Brentwood sets the standard for luxury suburban living in Middle Tennessee. With a median price near $900,000, it attracts executives, physicians, and families who want exceptional schools, large lots, and a safe, established community. Inventory here is always limited — serious buyers need a pre-approval in hand and an agent with relationships. That scarcity is structural, not seasonal: Brentwood\'s population has grown less than 1% since the 2020 Census (45,373 to an estimated 45,556, per the U.S. Census Bureau) because the city is almost fully built out, so new listings don\'t open up at the rate they do in growing suburbs like Spring Hill or Nolensville. Homes in Governors Club, Otter Creek, and Annandale rarely last more than a few weeks. If Brentwood is your target, working with a local expert who can surface off-market opportunities is the edge that makes the difference.',
    buyerWhyBullets: [
    ...
    buyerFaqs: [
      ...
      { q: 'Is Brentwood, TN still growing?', a: "Barely — and that's the point for buyers. Brentwood's population has grown less than 1% since the 2020 Census (45,373 to an estimated 45,556 today, per the U.S. Census Bureau), because the city is almost entirely built out. That means very little new construction and a fixed supply of resale homes, so buyers waiting for \"more options to open up\" typically wait in vain. Being ready to move fast on the right listing matters more here than in growing suburbs." },
    ],
  ...
  'smyrna-tn': {
    ...
    pricePerSqft: 190,
    yoyChange: '+3.9%',
    description: 'Smyrna is anchored by the Nissan Smyrna Vehicle Assembly Plant, the largest single-site auto plant in North America — producing roughly 640,000 vehicles a year and employing about 8,000 workers as the town\'s largest employer. That manufacturing base has driven real growth: Smyrna has climbed from 53,070 residents at the 2020 Census to an estimated 57,000+ in 2026, making it the largest town in Tennessee. With a 2026 median home price near $370,000 and homes averaging 22 days on market, Smyrna offers buyers and sellers a market backed by durable employment rather than pure Nashville-commuter speculation. Joshua Fink and Compass combine that local insight with modern marketing to position Smyrna properties for maximum visibility and return.',
    whyBullets: [
  ...
  'la-vergne-tn': {
    ...
    pricePerSqft: 180,
    yoyChange: '+4.0%',
    description: 'La Vergne sits at the crossroads of I-24, I-40, and I-65 in Rutherford County, and that logistics position is reshaping the market. The city has grown roughly 11% since the 2020 Census to an estimated 42,900+ residents in 2026 (U.S. Census Bureau), fueled by an expanding industrial and distribution base — including Amazon\'s local sortation and fulfillment operations and a new 1-million-square-foot warehouse under construction along I-24. With a 2026 median home price around $330,000, demand remains healthy among first-time buyers, workers relocating for that job growth, and budget-conscious commuters. Sellers in La Vergne benefit from this affordability-driven buyer pool and steady appreciation. Joshua Fink and Compass provide the local strategy needed to price accurately, market effectively, and move quickly in this active segment.',
    whyBullets: [
      'Affordability-driven demand: La Vergne consistently attracts qualified buyers priced out of Smyrna, Murfreesboro, and Nashville proper, drawn by the sub-$350K entry point and direct I-24/I-40/I-65 access.',
