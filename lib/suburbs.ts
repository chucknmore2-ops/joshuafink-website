...
export const suburbs: Record<string, Suburb> = {
  'franklin-tn': {
    ...
    yoyChange: '+4.2%',
    description:
      'Franklin, Tennessee is one of the most desirable suburbs in the entire Southeast. Anchored by a charming historic downtown, top-rated schools, and easy access to I-65, Franklin consistently ranks among the best places to live and invest in the country. The city has grown from 84,159 residents at the 2020 Census to an estimated 91,416 in 2026 — about 8.6% growth in six years, with Franklin outpacing the rest of Williamson County as the primary driver of the county\'s expansion (U.S. Census Bureau). The local real estate market has shown remarkable resilience — median home prices have climbed to $650,000 in 2026, driven by continued corporate relocations, limited inventory, and overwhelming buyer demand from out-of-state movers. Sellers in Franklin are well-positioned: well-maintained homes priced correctly are routinely fielding multiple offers within the first weekend.',
    whyBullets: [
    ...
    faqs: [
      ...
      {
        q: 'How much has Franklin, TN grown in recent years?',
        a: 'Franklin grew from 84,159 residents at the 2020 Census to an estimated 91,416 in 2026 — about 8.6% growth in six years (U.S. Census Bureau). Franklin is outpacing the rest of Williamson County and is the county\'s primary driver of growth, which is a big part of why demand — and prices — have held up even as inventory stays tight.',
      },
    ],
    schemaCity: 'Franklin',
    schemaState: 'TN',
    ...
    buyerFaqs: [
      ...
      { q: 'Who is the best real estate agent in Franklin, TN?', a: 'The right agent for Franklin is one with hyperlocal, subdivision-level knowledge — Franklin spans dozens of distinct neighborhoods (Westhaven, Fieldstone Farms, Cool Springs) with meaningfully different pricing, school zones, and HOA rules, so general Nashville-metro experience isn\'t enough. Joshua Fink is a Compass Affiliate Broker with 17+ years of experience personally closing 100+ home sales a year across Williamson County, including Franklin, and has direct off-market access through Compass\'s Coming Soon network — a real edge in a market where well-priced homes often go under contract within the first weekend.' },
    ],
