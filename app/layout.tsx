              ...
              '@graph': [
                {
                  ...
                  areaServed: [
                    ...
                    },
                    {
                      '@type': 'City',
                      name: 'Nolensville, TN',
                      geo: { '@type': 'GeoCoordinates', latitude: 35.954, longitude: -86.6722 },
                    },
                    {
                      '@type': 'City',
                      name: "Thompson's Station, TN",
                      geo: { '@type': 'GeoCoordinates', latitude: 35.8045, longitude: -86.8908 },
                    },
                    {
                      '@type': 'City',
                      name: 'Nashville, TN',
                    ...
                    },
                    {
                      ...
                      geo: { '@type': 'GeoCoordinates', latitude: 36.3048, longitude: -86.62 },
                    },
                    {
                      '@type': 'City',
                      name: 'Columbia, TN',
                      geo: { '@type': 'GeoCoordinates', latitude: 35.6151, longitude: -87.0353 },
                    },
                    {
                      '@type': 'City',
                    ...
                    },
                    {
                      '@type': 'City',
                      name: 'Smyrna, TN',
                      geo: { '@type': 'GeoCoordinates', latitude: 35.9828, longitude: -86.5186 },
                    },
                    {
                      '@type': 'City',
                      name: 'La Vergne, TN',
                      geo: { '@type': 'GeoCoordinates', latitude: 36.0156, longitude: -86.5819 },
                    },
                  ],
