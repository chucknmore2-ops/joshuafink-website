                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" id="mid-name" name="name" required placeholder="Jane Smith" autoComplete="name"
                  ...
                  <div>
                    <label htmlFor="mid-email" className="block text-xs font-semibold text-black tracking-widest uppercase mb-2">Email (optional)</label>
                    <input type="email" id="mid-email" name="email" placeholder="you@example.com" autoComplete="email"
                      className="w-full border border-[#E8E8E8] px-4 py-3 text-sm text-black placeholder-[#A0A0A0] focus:outline-none focus:border-black transition-colors" />
                  </div>
        ...
        <div className="text-white py-16 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#0A1628' }}>
          ...
          <div className="max-w-3xl mx-auto mt-12 bg-white p-8 sm:p-10">
            ...
            >
              ...
              <div>
                <label htmlFor="email" className="block text-xs font-semibold text-black tracking-widest uppercase mb-2">Email (optional)</label>
