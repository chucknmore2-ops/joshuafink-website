...
export const metadata: Metadata = {
  ...
  description:
    'Find homes for sale near Ravenwood, Brentwood, Page, Independence, Centennial, Nolensville, Blackman, Station Camp, Beech, and Wilson Central High Schools. School-zone-first home search from Joshua Fink at Compass Real Estate.',
