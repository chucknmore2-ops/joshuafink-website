...
export const metadata: Metadata = {
  ...
  description:
    'Find homes for sale near Ravenwood, Brentwood, Page, Independence, Centennial, Nolensville, Blackman, Station Camp, Gallatin, Beech, Wilson Central, and Julia Green Elementary school zones. School-zone-first home search from Joshua Fink at Compass Real Estate.',
