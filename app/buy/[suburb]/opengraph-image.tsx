...
export const alt = 'Buy a Home in Middle Tennessee — Joshua Fink, Compass'
...
export default async function Image({ params }: { params: { suburb: string } }) {
  ...
  const ppsqft = suburb?.pricePerSqft
      ...
      >
        ...
        >
          <div style={{ display: 'flex', gap: 40 }}>
            ...
            {ppsqft && (
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <span style={{ fontSize: 36, fontWeight: 900 }}>${ppsqft}</span>
                <span
                  style={{
                    fontSize: 13,
                    letterSpacing: '0.2em',
