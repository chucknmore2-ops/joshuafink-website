      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'WebPage',
            name: `Buy a Home in ${suburb.displayName} | Joshua Fink — Compass`,
            url: `https://www.joshuafink.com/buy/${slug}`,
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-10 max-w-xl bg-white p-6 sm:p-7">
              ...
              >
                ...
                >
                  {suburb.name} Insider Report — same-day reply
                </button>
        ...
        {cityGuides.length > 0 && (
          <div className="bg-white border-t border-[#E8E8E8] py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <h2 className="text-3xl font-black text-black tracking-tight mb-3">
                Explore {suburb.name} Neighborhoods
              </h2>
              <p className="text-[#6B6B6B] text-sm leading-relaxed max-w-3xl mb-10">
                Honest, in-depth guides to {suburb.name}&apos;s most-searched subdivisions —
                schools, HOA, amenities, home styles, and current price ranges. Live listings
                are served on Compass with Joshua as your attributed agent.
              </p>
