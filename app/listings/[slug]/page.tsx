    ...
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-14">
          ...
          {/* Right: lead capture — follows the property details on mobile so price, address and specs
              land directly under the photo; the sticky "Ask Joshua" CTA jumps to #lead from anywhere */}
