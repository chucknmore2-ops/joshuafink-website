#!/usr/bin/env python3
"""Joshua Fink Group Cash Offer Content Engine — local SEO article factory."""
...
log = logging.getLogger("jfg-cashoffer-engine")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="JFG Cash Offer Content Engine")
    parser.add_argument("--batch", type=int, default=2, help="Number of articles per batch run")
